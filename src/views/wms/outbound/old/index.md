<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="来源单据类型" prop="sourceBillType">
        <el-select
          v-model="queryParams.sourceBillType"
      ...
      <el-form-item label="特别说明，创建方专用" prop="creatorComment">
        <el-input
          v-model="queryParams.creatorComment"
          placeholder="请输入特别说明，创建方专用"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="来源单据ID" align="center" prop="sourceBillId" />
      <el-table-column label="来源单据号" align="center" prop="sourceBillNo" />
      <el-table-column label="来源单据类型" align="center" prop="sourceBillType" />
      <el-table-column label="特别说明，创建方专用" align="center" prop="creatorComment" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
