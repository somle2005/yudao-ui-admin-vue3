<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="待出库量" prop="outboundPendingQuantity">
        <el-input
          v-model="queryParams.outboundPendingQuantity"
          placeholder="请输入待出库量"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['wms:stock-bin:create']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="库位ID" align="center" prop="binId" />
      ...
      <el-table-column label="待出库量" align="center" prop="outboundPendingQuantity" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
