  ...
  <div style="display: contents">
    ...
    >
      <el-table border :data="formData" class="-mt-10px" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="包装长(mm)" prop="packageLength" width="100" align="center" />
        <el-table-column label="包装宽(mm)" prop="packageWidth" width="100" align="center" />
        <el-table-column label="包装高(mm)" prop="packageHeight" width="100" align="center" />
